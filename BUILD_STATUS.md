# Build Status — v0.1.1 Physical-Validation Candidate
...
Current maintained suite: **94 passing tests**.

Measured Python test coverage after the latest audit is approximately **90% overall**, with the deterministic diagnosis engine at **100% statement coverage** in the maintained suite. UI/platform branches that require real Kodi/Windows remain lower and are explicitly covered by physical gates.
